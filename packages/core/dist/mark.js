...
export var rect = function (_a) {
    ...
    return ({
        ...
        renderFn: function (canvas, index) {
            return _jsx("rect", { x: canvas.left, y: canvas.top, width: canvas.width, height: canvas.height, fill: fill }, index);
        }
    });
};
...
export var text = function (_a) {
    ...
    var measurements = measure("$measuring", _jsx("text", __assign({ fontFamily: fontFamily, fontSize: fontSize, fontStyle: fontStyle, fontWeight: fontWeight, fill: fill }, { children: contents }), void 0));
...
export var nil = function () { return ({
