import { hSpace, vSpace, alignBottom, alignRight, alignTop, vAlignCenter, hAlignCenter } from '../gestalt';
import { debug, rect, text } from '../markExistential';
...
export var barChartGlyphFn = GlyphFn.mk({
    ...
    relations: [
        ...
        {
            fields: ["yAxis", "data/elements/0/value"],
...
export var barChart = compileGlyphFn(chartWithThings)({
    data: mkList(data),
    yTicks: mkList(ticks),
});
//# sourceMappingURL=barchartExistential.js.map