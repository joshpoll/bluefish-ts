import { hSpace, vSpace, alignLeft, alignBottom, alignRight, vAlignCenter, hAlignCenter } from '../gestalt';
...
export var boundingBox = compileGlyphFn(chartWithThings)({
    data: mkList(data),
    yTicks: mkList(ticks),
});
//# sourceMappingURL=boundingboxexample.js.map