...
import { hSpace, vSpace, alignLeft, alignBottom, alignRight, alignTop } from '../gestalt';
...
export var bars = function (data) { return ({
    ...
    relations: zipWith(_.range(data.length - 1), _.range(1, data.length), function (curr, next) { return ({ left: curr.toString(), right: next.toString(), gestalt: [alignBottom, hSpace(20.)] }); }),
}); };
/* TODO:
...
export var dataGlyph = {
    children: {
        ...
        "xAxis": xAxis(data.map(function (_, i) { return 10 + 25 * i; })),
        "yAxis": yAxis(ticks),
        "bars": bars(data),
    },
    relations: [
