...
import { createShape, Shape, Mark, ShapeValue } from './unifiedShapeAPI2';
...
export const rect = (params: Rect): Mark => createShape(
  {
...
export const ellipse = (params: Ellipse): Mark => createShape(
  {
    // return the positioning parameters the user gave us
...
export const text = (params: Text): Mark => {
...
export const line = (params: Line): Mark => {
...
export const nil = (): Mark => createShape(
  {
...
export const loc = ({ x, y }: LocParams): Mark => createShape(
  {
...
export const html = (params: HTML): Mark => {
